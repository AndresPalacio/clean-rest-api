...
import static com.example.service.user.infrastructure.utils.DataFaker.fakeSaveUserBodyDto;
import static com.example.service.user.infrastructure.utils.DataFaker.fakeUserData;
...
class UserControllerIntegrationTest {
    ...
    public void shouldRetrieveAllUsers_whenPrePopulatedOnTheDatabase() throws Exception {
        ...
        userRepository.saveAll(Arrays.asList(userData1, userData2));
